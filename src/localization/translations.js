window.translationsData = {
  en: {
    ...
    insufficientModelClearance: "Selected model clearance",
    insufficientForDocuments: "is insufficient for the chat's documents",
    required: "required",
    pleaseSelectHigherClearanceModel:
      "Please select a model with higher clearance.",
    openInformationModelNotice:
      "Note: This model only supports open information. Avoid sharing classified data.",
  ...
  sv: {
    ...
    tokenLengthWarning:
      "Den här chatten börjar bli fär lång. Du behöver snart starta en ny chatt.",
    ...
    classificationOption5: "5: Säkerhetsklassad",
    ...
    noAvailableModels: "Inga modeller har tillräcklig behörighet",
    insufficientClearance: "otillräcklig behörighet",
    insufficientModelClearance: "Vald modells behörighet",
